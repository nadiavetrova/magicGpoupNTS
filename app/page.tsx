...
const panels = [
  ...
  },
  {
    ...
    body: [
      "Помогаем найти недвижимость, которая подходит именно вам — будь то уютная квартира для жизни, апартаменты у моря или доходный объект за рубежом.",
    ...
    services: {
      title: "Мы рады помочь Вам:",
      items: [
        { icon: "01", name: "Продать", hint: "Квартиру, дом, земельный участок, коммерческую недвижимость и т.д." },
        { icon: "02", name: "Купить", hint: "Новостройки, вторичка, частный дом, коммерция и т.д." },
        { icon: "03", name: "Одобрение ипотеки", hint: "Рыночная, семейная, IT, военная и т.д." },
        { icon: "04", name: "Недвижимость за рубежом", hint: "Поиск, сделка, юридическое сопровождение (Турция, Вьетнам, Тайланд, ОАЭ и т.д.)" },
      ],
